...
| 展示層 | `services/api`、`apps/dashboard` | ✅ REST API＋Streamlit 儀表板（含值勤模式、影像頁與使用指南），端點與頁面集合由契約測試守住，且每頁以 AppTest 實跑驗證可渲染 |
...
| **太陽與行星際影像** | 11 張公開影像：黑子／日珥／磁圖／日冕儀、CME 傳播模擬、D 層吸收、全球 TEC、極光橢圓 |
